...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref 0f488ac
  WORKING_DIRECTORY "C:/Users/40204497/Desktop/set08116/labs_build/glfw-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/0f488ac")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "0f488ac")
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 0f488ac
  WORKING_DIRECTORY "C:/Users/40204497/Desktop/set08116/labs_build/glfw-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/40204497/Desktop/set08116/labs_build/glfw-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/40204497/Desktop/set08116/labs_build/glfw-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "C:/Program Files/Git/cmd/git.exe" checkout 0f488ac
      WORKING_DIRECTORY "C:/Users/40204497/Desktop/set08116/labs_build/glfw-src"
      RESULT_VARIABLE error_code
      )
    if(error_code)
