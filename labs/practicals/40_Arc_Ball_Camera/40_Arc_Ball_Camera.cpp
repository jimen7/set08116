...
bool update(float delta_time) {
  ...
  if (glfwGetKey(renderer::get_window(), 'W')) {
	  auto translation = vec3(0.0f, 0.0f, -3.0f);
	  meshes["chaser"].get_transform().position += translation*delta_time;
	 cam.translate(translation*delta_time);
  }
  ...
  if (glfwGetKey(renderer::get_window(), 'A')) {
	  auto translation = vec3(-3.0f, 0.0f, 0.0f);
	  meshes["chaser"].get_transform().position += translation*delta_time;
	  cam.translate(translation*delta_time);
  }
